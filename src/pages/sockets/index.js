    ...
    useEffect(() => {
        if (ready && !signed) {
            (async () => {
                ...
                const verifyContract = new rink_web3.eth.Contract(
                    verifyABI,
                    '0xF80CED404BC9272051149AC5e505FfBFb8f06ed5'
                );
    ...
    return (
        ...
        >
            <div>
                                    ...
                                    <div className="has-text-centered">
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                ...
                                                setSignResult({ done: false, error: false, msg: '' });
                                            }}
                                        >
                                            Try again
                                        </button>
                ...
                <br />
                {signResult.done ? null : (
                    <div className="has-text-white has-text-centered">
                        Please stay in the website until verification is done
                    </div>
                )}
            </div>
        </div>
