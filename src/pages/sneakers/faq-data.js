const faq = [
    ...
    },
    {
        ...
        answer: () => (
            <p className="has-text-white">
                There are huge opportunities for this in-show asset going forward, including collaborating with artists,
                shoe designers and manufacturers (e.g., Nike). <br />
                <br /> TRAF is also exploring influencer collaborations to promote the Gravity Sneakers (both real and
                virtual), including celebrities and the NBA community.
            </p>
        ),
    },
];
