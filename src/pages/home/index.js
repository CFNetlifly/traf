...
const HomePage = (props) => {
  ...
  return (
    <div
      className={`${assetsLoaded >= 35 ? "" : "home-sizer-null"}`}
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              className="columns is-vcentered  px-3"
          ...
          <div className="">
            ...
            <div className="my-6">
              <div className="columns">
                <div className="column has-text-centered">
                  <h1 className="subtitle has-text-white has-text-weight-bold mb-3 is-3">
                    {" "}
                    EPISODE 1{" "}
                  </h1>
                  <h1 className="subtitle has-text-white has-text-weight-bold mb-3 is-3">
        ...
        content={
          <div>
            <h1 className="title has-text-white is-4 has-text-left has-text-weight-bold">
              SEASON 1 <span className="has-text-warning">EP 1</span>
            </h1>
      ...
      <SectionLayout
        ...
        content={
          <div>
            <h1 className="title has-text-white is-4 has-text-left ">
              SEASON 1 MIDSEASON{" "}
              <span className="has-text-warning">ROADMAP</span>{" "}
            </h1>
            <br />
            <br />
            <div
      ...
      <SectionLayout
        ...
        content={
          <div>
            <h1 className="title has-text-white is-4 has-text-left has-font-title">
              TURN YOUR NFT INTO A STAR AND{" "}
              <span className="has-text-warning">GET PAID</span>!
            </h1>
            <br />
            <br />
            <div
              className="columns is-vcentered"
              style={{ background: "#FCE711" }}
            >
              <div className="column p-0 is-4">
                <figure className="image">
                  <img src={guest} alt="" />
      ...
      <SectionLayout
        ...
        content={
          <div className="">
            <h1 className="title has-text-white is-4 has-text-centered">
              ...
              {[...teamData].splice(0, 3).map((t, i) => (
                <div className="column has-text-centered" key={i}>
                  ...
                  <div className="" style={{ height: "80px" }}>
                    <h1 className="title has-text-white is-5 has-text-centered">
                      {t.name}
                    </h1>
                  ...
                  <h1 className="subtitle has-text-white is-5 has-text-centered">
                    <ReactHtml html={t.link} />
                  </h1>
                </div>
              ))}
              <div className="column"></div>
      ...
      <SectionLayout
        ...
        content={
          <div>
            ...
            <br />
            <br />
            <h1 className="subtitle has-text-white has-text-centered mb-5">
              Starting Episode 2
            </h1>
            <br />
      ...
      <SectionLayout
        ...
        content={
          <div className="has-text-centered">
            <h1 className="title has-text-warning is-4">
              MUSKVILLE IS WAITING!
            </h1>
            <h1 className="title has-text-white is-3">
              Get your ticket to Mars and Join our Discord!
            </h1>
            <br />
            <a
              href="https://discord.gg/HxE754wj9r"
          ...
          <div>
            ...
            <div className="columns">
              {[...partnersData].splice(0, 5).map((p, i) => (
                <div className="column has-text-centered" key={i}>
                  <h1 className="title is-5 has-text-centered has-text-warning">
                    {p.name}
                  </h1>
