    ...
    const getWebData = async () => {
        if(props.wallet.connectedToOperatingNetwork){
            ...
            try {
                ...
                webData.giveaway1 = 167 - (333 - Number(webData.leftNFT));
                    ...
                    <span className="has-text-warning" onClick={e => setVideoOpen(true)}>
                        
                        {
                            webData && webData.giveaway1 ?
                                ...
                                <div>
                                    TOKENS TILL SECOND MUTANT GIVEAWAY
                                    <br/>
                                    {webData.giveaway1}
                                </div>
                            :
                               <div> CONNECT YOUR WALLET TO SEE HOW MANY MINTS LEFT UNTILL SECOND MUTANT GIVEAWAY</div>
                        }                        
                    </span>
