const data = [
    ...
    },
    {
        ...
        body: 'We will feature guest NFTs and art in future episodes in a variety of ways (plot dependent). Your NFT and art will potentially benefit of off an increase in  its value Head over to our Discord to learn more. <br/><br/> At the same time, we’re constantly exploring new and innovative ways to give even more back to the NFT community. <br/><br/> For example: we are introducing a CASTING SESSION for BAYC Ape holders that bought episode 1. ',
    },
    {
