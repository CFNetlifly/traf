...
import member11Png from "media/member11.jpg";
import member12Png from "media/member12.svg";
import member13Png from "media/member13.jpg";
// import member14Png from 'media/member14.png';
...
export const member3 = member3Png; //Hashem zaino
// export const member4 = member4Png;  //Chris Goward
// export const member5 = member5Png;  //Neil Jacques
export const member6 = member6Png; //Dr. Maher F Shirah
export const member7 = member7Png; //Naji Aljabiri
export const member9 = member9Png; //Sarah Khorbtli
export const member8 = member8Png;
// export const member10 = member10Png;  //Eric Spivak
export const member11 = member11Png; //Zaini Media
export const member12 = member12Png; //Crypto Family
export const member13 = member13Png; //Adel Antablih
// export const member14 = member14Png;  //Ramzi Faris
