        ...
        <footer className="footer has-background-black py-5">
            <div className="container has-text-centered">
                ...
                <p>
                    ...
                    <a className="is-size-4 " href="https://opensea.io/collection/theredapefamily" target="_blank" className="ml-4">
                ...
                <h1 className="subtitle has-text-warning is-6 mb-3">
                    <a className="has-text-warning" href=" https://etherscan.io/address/0x38Ef1bF1503eFe695525211f5E2cEa9F7BD01cc3" target="_blank">Episode 1 Royalties Wallet</a>
                    &nbsp;
                    | 
                    &nbsp;
                    <a className="has-text-warning" href=" https://etherscan.io/address/0xce0aD44D305f803BBbA241B8cba8F2A975a88600" target="_blank">Episode 2 Royalties Wallet</a>
                </h1>
